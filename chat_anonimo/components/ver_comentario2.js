    ...
    return (
        <div className="contenedor_mensaje">
            <div className="d-flex justify-content-between">
                <div className="cabecera_mensaje d-flex">
                    ...
                    <div className="ps-3"> 
                        ...
                        <p className="pijazo rojitoop m-0">{comentario.createdAt.substring(0,10)}</p>
                    </div>
                </div>
            ...
            <div className="respuestas_mensaje">
                <Escribir_mensaje respuestas={respuestas} setNuevaRes={setRespuesta} id_usuario={id_usuario} id_grupo={id_grupo} idComentario={comentario._id} nickUsuario={nickUsuario}/>
            </div>
            
            {/* RESPUESTAS */}
            <div className="asdasdfasdfasxDDasd">
                {
                    respuestas.map(respuesta =>(
                        ...
                        <div className="contenedor_respuesta_xd ">
                            ...
                            <div className="w-100">
                                ...
                                <p className="m-0 rojitoop text-break">{respuesta.mensaje}</p>
                            </div>
                        </div>
                    ) )
                }
