        ...
        <div className="div_contenedor_grupo">
                ...
                <div className="panel_mensajes">
                    ...
                    <div className="boton_panel">
						...
						<a onClick={ () => { setVistaGrupo(<Comentarios_leidos id={inforUsuario.usuario._id} id_g={idGrupoVista} comentariosLeidos={ComentariosLeidos} cambiarVista={setVistaGrupo} nicknameUsuario={inforUsuario.usuario.nickname} />)}} className="link-light w-100" >Comentarios leidos</a>
