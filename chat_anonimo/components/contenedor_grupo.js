        ...
        <div className="div_contenedor_grupo">
                ...
                <div className="panel_mensajes">
                    ...
                    <div className="boton_panel">
						...
						<a onClick={ () => { setVistaGrupo(<Comentarios_leidos comentariosLeidos={ComentariosLeidos} cambiarVista={setVistaGrupo} nicknameUsuario={inforUsuario.usuario.nickname} />)}} className="link-light w-100" >Comentarios leidos</a>
                    ...
                    <div className="boton_panel">
						...
						<a onClick={ () => { setVistaGrupo(<Comentarios_nuevos comentariosNuevos = {ComentariosNuevos}/>)}} className="link-light w-100" >Comentarios nuevos</a>
                    ...
                    <div className="boton_panel">
						...
						<a onClick={ () => { setVistaGrupo(<Agregar_miembros id= {inforUsuario.usuario._id} id_g={idGrupoVista}/>)}} className="link-light w-100" >Agregar miembros</a>
