...
export default function Contenedor_grupo(){
    ...
    const [vista, cambiarVista] = useState()
  ...
  <path fillRule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                           ...
                           {/*  <a onClick={ () => { cambiarVista(Crear_comentario)}} className="link-light w-100" >Crear comentario</a> */}
                                ...
                                <Link to="/inicio/crear-comentario">Crear comentario</Link>
                    ...
                    <div className="boton_panel">
                        ...
                        <Link to="/inicio/comentarios-leidos">Comentarios leidos</Link>
                    ...
                    <div className="boton_panel">
                        ...
                        <Link to="/inicio/comentarios-nuevos">Comentarios nuevos</Link>
                    ...
                    <div className="boton_panel">
                        ...
                        <Link to="/inicio/agregar-miembro">Agregar miembros</Link>
                    ...
                    <div className="boton_panel">
                        ...
                        <Link to="/inicio/ver-grupo">Ver grupo</Link>
				...
				<div className="mequierosuicidar">
					<Switch>
						...
						<Route exact path="/inicio/crear-comentario">
							<Crear_comentario />
						</Route>
						
						<Route exact path="/inicio/comentarios-leidos">
							<Comentarios_leidos />
						</Route>
						
						<Route exact path="/inicio/comentarios-nuevos">
							<Comentarios_nuevos />
						</Route>
					
						<Route exact path="/inicio/agregar-miembro">
							<Agregar_miembros />
						</Route>
						
						<Route exact path="/inicio/ver-grupo">
							<Ver_grupo />
						</Route>
