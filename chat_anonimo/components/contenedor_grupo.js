...
export default function Contenedor_grupo(){
  ...
  <path fillRule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
                            ...
                            <a onClick={ () => { cambiarVista(Enviar_comentario)}} className="link-light w-100" >Crear comentario</a>
                    ...
                    <div className="boton_panel">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-envelope-open" viewBox="0 0 16 16">
                            ...
                            <a onClick={ () => { cambiarVista(Comentarios_leidos)}} className="link-light w-100" >Comentarios leidos</a>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-envelope" viewBox="0 0 16 16">
                            ...
                            <a onClick={ () => { cambiarVista(Comentarios_nuevos)}} className="link-light w-100" >Comentarios nuevos</a>
                    ...
                    <div className="boton_panel">
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-person-plus" viewBox="0 0 16 16">
                            ...
                            <a onClick={ () => { cambiarVista(Agregar_miembros)}} className="link-light w-100" >Agregar miembro</a>
                ...
                <div className="ranciadaa">
                    ...
                    <Escribir_mensaje
                        mensajes={mensajes}
                        agregarMensajes={agregarMensajes}
                    />
                </div>
